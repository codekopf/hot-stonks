...
import static com.codekopf.hotstonks.HotStonksApplication.DOWNLOAD_FILE_PATH;
 ...
 */
public class ZomatoMenuScraper implements MenuScraper {
    private final String urlSuffix;
    private final String name;

    public ZomatoMenuScraper(String name, String urlSuffix) {
    ...
    public void getMenu() throws IOException {
        ...
        try {
            ...
            driver.get("https://www.zomato.com/cs/praha/" + urlSuffix);

            WebDriverWait wait = new WebDriverWait(driver, 10);
            WebElement menu = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("respageMenuContainer")));
            driver.executeScript("return arguments[0].remove();", menu);
            WebElement ele = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("tmi-groups")));
            ...
            File screenshotLocation = new File(DOWNLOAD_FILE_PATH + name + ".png");
