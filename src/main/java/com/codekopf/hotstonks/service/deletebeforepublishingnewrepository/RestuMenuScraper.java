...
/**
 * Created by mstaffa on 12/07/2019
 */
public class RestuMenuScraper implements MenuScraper {
    private final String name;
    private final String urlSuffix;

    public RestuMenuScraper(String name, String urlSuffix) {
        this.name = name;
    ...
    public void getMenu() throws IOException {
        ...
        try {
            ...
            driver.get("https://www.restu.cz/" + urlSuffix);

            WebDriverWait wait = new WebDriverWait(driver, 10);
            WebElement ele = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("menu-section")));
            ...
            File screenshotLocation = new File(HotStonksApplication.DOWNLOAD_FILE_PATH + name + ".png");
